						...
						<div class="d-flex">
							...
							<div class="auth-block">
								<ul class="nav navbar-nav flex-row">
									<li><a href="https://wagonex.com/request-call-back" class="request-call-button">Request call back</a></li>
									<li><a href="https://wagonex.com/signin" class="login">Log in</a></li>
									<li><a href="https://wagonex.com/register?domain=AAM" class="join-us">Join Us</a></li>
								</ul>				
							</div>					
						</div>								
