        ...
        <h2 class="text-center mt-4 mb-5">Featured vehicles</h2>
            <div class="owl-carousel feature-vehicle owl-loaded owl-drag">
                <div class="owl-stage-outer">
                    <div class="owl-stage" style="transition: all 2s ease 0s; width: 5515px; transform: translate3d(-1225px, 0px, 0px);"><div class="owl-item cloned"><div class="white-box-container" car_detail_url="http://app.wagonex.local/Abarth/Spider125/WGDX-73/351">
