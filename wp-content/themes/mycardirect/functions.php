...
function twentytwenty_sidebar_registration()
{
    ...
    register_sidebar(
        array_merge(
            array(
                'name'        => __('Meta tag', 'twentytwenty'),
                'id'          => 'meta-tag',
                'description' => __('Widgets in this area will be used for meta tag.', 'twentytwenty'),
                'before_title'  => '',
                'after_title'   => '',
                'before_widget' => '',
                'after_widget'  => '',
...
function add_custom_general_setting()
{
    //setting name, display name, callback to print form element, page in which field is displayed, section to which it belongs.
    //last field section is optional.
    add_settings_field("app_site_url", "APP Address (URL)", "display_app_site_url", "general", "default");

    //section name, form element name, callback for sanitization
    register_setting("general", "app_site_url", [
        'type' => 'url',
        'description' => __('APP Address(URL) to link your wordpress site to Browse Cars and Login/Register pages.')
        ]);
}

function display_app_site_url()
{
    //id and name of form element should be same as the setting name.
    ?>
        <input type="url" name="app_site_url" id="app_site_url" value="<?php echo get_option('app_site_url'); ?>" class="regular-text code" placeholder="i.e. http://app.domain.com">
    <?php
}

add_action("admin_init", "add_custom_general_setting");